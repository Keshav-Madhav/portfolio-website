...
export function buildRagSystemPrompt(
  ...
  if (opts.deep) {
    ...
    parts.push(
      ...
      "  3. **Timeline & how it evolved** — ONLY if the retrieved context",
      "     contains dates / version numbers / month-year stamps for THIS",
      "     specific project. Otherwise SKIP this beat entirely.",
      ...
      "These are NON-NEGOTIABLE for deep-dive answers:",
      "",
      "  • **Dates / years / versions are SACRED.** Use ONLY dates that",
      "    appear LITERALLY in retrieved chunks that explicitly name THIS",
      "    project. Do NOT borrow dates from origin / college / childhood",
      "    chunks. Example: if the visitor asks about Grid Math and the",
      "    retrieved chunks say it was a 4-day sprint in April 2026, say",
      "    that. Do NOT say \"started in college around 2022\" just because",
      "    a college chunk happened to be retrieved.",
      "",
      "  • If retrieved context for this specific project has NO dates,",
      "    say something like \"I built this over a focused sprint\" or",
      "    \"I don't have the exact timeline handy\" — then move on. NEVER",
      "    invent a year range to pad the structure.",
      "",
      "  • **Ignore irrelevant retrieved chunks.** Retrieval is fuzzy. A",
      "    chunk about Keshav's college years or the pivot to programming",
      "    is NOT timeline data for a specific project. If a retrieved",
      "    chunk doesn't mention the project by name (or its core tech),",
      "    do not draw \"facts\" from it.",
      "",
      "  • **Numbers, install counts, framework names, version strings**",
      "    must come from retrieved chunks that name this project. No",
      "    extrapolation, no \"probably uses X\".",
      "",
      "  • If you genuinely don't have enough about this specific project,",
      "    say so in 2-3 sentences and offer GitHub / email. A short honest",
      "    answer is ALWAYS better than a long fabricated one.",
    );
  }
